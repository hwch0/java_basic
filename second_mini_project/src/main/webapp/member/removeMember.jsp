...
<body>
	<div id="container">
		...
		<div id="formList">
			<h1 >회원탈퇴</h1>
			<form action="remove.jsp" method="post" autocomplete="off" >
			<label for="pwd">비밀번호 : </label>
			<input id = "pwd" type="password" name="pwd" /><br/>
			<input id = "pwd2" type="password" name="pwd2" value="<%=loginMember.getPwd() %>" style="visibility:hidden"/>
			<input id = "uid" type="text" name="uid" value="<%=loginMember.getUid() %>" style="visibility:hidden"/>
